...
CANONICAL_ALIASES = {
    ...
    "Tanggal Onset": ["tanggal_onset", "onset_date", "onset"],
    "Tanggal Pemeriksaan": ["tanggal_pemeriksaan", "examination_date", "exam_date"],
    "Tanggal Pelaporan": ["tanggal_pelaporan", "reporting_date", "tanggal_lapor"],
